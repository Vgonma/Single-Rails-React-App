...
# 📖 Single Rails React App <a name="about-project"></a>

**Single Rails React App** is a mobile web application where you can manage your budget: you have a list of transactions associated with a category, so that you can see how much money you spent and on what.
...
1. Download the **Zip** file or clone the repo with:
 ```bash
git git@github.com:Vgonma/Single-Rails-React-App.git
```
2. To access cloned directory run:
```bash
cd Single-Rails-React-App
```
